...
function SignIn() {
    ...
    return (
        <>
            <Head>
                <title>Terra Vault - Welcome</title>
            </Head>
            <section className='bgGradientBackground min-h-screen flex items-center justify-center px-3 md:px-0'>
                <div className='bgGlassmorphismBlur flex rounded-2xl shadow-lg max-w-3xl px-0 py-24 md:px-5 md:py-5  items-center'>
                    <div className='md:w-1/2 px-8 md:px-16'>
                        ...
                        <button
                            ...
                            type='button'
                            id='login'
                            className='bg-gradient-to-r from-purpledark to-orange py-2 w-full rounded-xl mt-5 flex justify-center font-bold items-center text-md md:text-sm hover:scale-105 duration-300 font-roboto text-black'>
                            {loading ? (
                    ...
                    <div className='md:block hidden w-1/2'>
                        <img
                            ...
                            src='https://res.cloudinary.com/kabupaten-sukoharjo/image/upload/v1707229085/TerraVaultSignin_1_lejyv3.png'
                        />
                    </div>
                </div>
            </section>
