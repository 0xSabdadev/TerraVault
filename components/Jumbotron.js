        ...
        <section className='pt-20 bgGradientBackgroundUp dark:bg-gray-900 '>
            <div className='py-8 px-4 mx-auto max-w-screen-xl text-left lg:py-16 relative'>
                <a
                    ...
                    <span className='text-6md px-4 py-1.5 me-3'>
                        
                    </span>{' '}
                    <span className='text-6md font-medium font-roboto'>
                        Create your own threshold signature wallet with the recently launched Terra Vault
                        dapps!
                    </span>
                    <svg
                ...
                <h1 className='text-left mb-4 py-4 text-4xl font-extrabold font-roboto tracking-tight leading-none bg-gradient-to-r from-purpledark to-orange text-transparent bg-clip-text md:text-5xl lg:text-6xl dark:text-white'>
                    Threshold Signature Factory Explorer
                </h1>
                ...
                <button
                    ...
                    disabled={loading}
                    type='button'
                    className='bg-purplemain hover:bg-gradient-to-r from-purpledark to-orange font-roboto text-white font-medium rounded-lg text-lg px-10 py-3 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2 transition duration-300 delay-80'>
                    {loading ? (
